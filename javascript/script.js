...
document.querySelector("#showCat").innerHTML = "<span>Persialainen</span> on kotikissarotu, joka tunnetaan pitkäkarvaisuudestaan ja lyhyestä kuonostaan.(www.wikipedia.org)";
...
document.querySelector("#showCat").innerHTML = "<span>American Curl</span> Rodulle on tyypillistä erikoisen näköiset korvat, jotka kiertyvät taakse poispäin kasvoista.(www.wikipedia.org)";
...
document.querySelector("#showCat").innerHTML = "<span>Bengali</span>Tyypillistä bengalille ovat lihaksikas ja pitkänomainen vartalo ja pienehkö pää suhteessa vartaloon.(www.wikipedia.org)";
...
document.querySelector("#showCat").innerHTML = "<span>Abessiinialainen</span> on leikkisä ja hieman pienikokoista puumaa muistuttava kissarotu. Se on yksi vanhimmista tunnetuista kissaroduista, ja sen tunnusmerkki on turkin ticking-kuviointi.(www.wikipedia.org)";
